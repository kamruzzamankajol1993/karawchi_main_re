...
<tr>
    ...
    <td>
        <a href="{{ route('kitchen.print_kot', ['id' => $kot->id, 'source' => 'report']) }}" class="progga-btn progga-btn-primary progga-btn-sm js-pos-print-preview" data-title="KOT" data-return-pos="1">
...
@empty
<tr>
    <td colspan="10" class="text-center text-muted" style="padding:32px 12px;">No KOT history found.</td>
</tr>
@endforelse
