...
<div class="receipt-card">
    ...
    <table class="report-table">
        ...
        @endforeach
        <tr style="border-top:1px solid #000;"><td style="padding-top:1.4px;">Total Due</td><td class="text-end" style="padding-top:1.4px;">{{ \App\Support\CurrencyFormatter::bdAmount(($closingExtraSummary['due'] ?? 0) + collect($deliveryPartnerDue ?? [])->sum('due')) }}</td></tr>
    </table>
    ...
    <table class="report-table">
        @foreach(['Cash' => 'Cash', 'Card' => 'Bank / Card', 'MFC' => 'MFS'] as $methodKey => $methodLabel)
            ...
            @endforeach
        @endforeach
        <tr style="font-size:10px;border-top:1px solid #000;"><td style="padding-top:1.4px;">Total Collection</td><td class="text-end" style="padding-top:1.4px;">{{ \App\Support\CurrencyFormatter::bdAmount($totalIncome) }}</td></tr>
    </table>
    ...
    <table class="report-table">
        ...
        <tbody>
            ...
            <tr style="font-size:10px;border-top:1px solid #000;"><td style="padding-top:1.4px;">Total</td><td class="text-end" style="padding-top:1.4px;">{{ \App\Support\CurrencyFormatter::bdAmount(array_sum($departmentIncome ?? [])) }}</td></tr>
        </tbody>
    </table>
